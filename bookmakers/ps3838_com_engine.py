...
class Ps3838Com:
    ...
    async def loop_markets(self, markets_, match):
        print(markets_, match)
        sport_id = self.get_sport_id(match[4])
        # print(sport_id)
        jmarkets = markets_[sport_id]
        converted_m_list = []
        # print("match:", match[0])
        # print("jmarket:", jmarkets['n'][0][2][0][2][0][0])
        # print(markets_)
        # print("dict:", dict)
        try:
            # markett = list(filter(lambda dict: dict[0] == match[8], jmarkets['n'][0][2]))[0][2][0]
